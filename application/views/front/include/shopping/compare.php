				  ...
				  <div class="table-responsive">
					<table class="table table-bordered table-hover">
					  ...
					  <tbody>
						<tr>
						  <td>Product</td>
						  <td><a href="product.html">Laptop Silver black</a></td>
						  <td><a href="product.html">Strategies for Acquiring Your Own Laptop</a></td>
						  <td><a href="product.html">Aspire Ultrabook Laptop</a></td>
						</tr>
						<tr>
						  <td>Image</td>
						  <td class="text-center"><img class="img-thumbnail" title="Laptop Silver black" alt="Laptop Silver black" width="100px" src="image/demo/shop/product/e4.jpg"></td>
						  <td class="text-center"><img class="img-thumbnail" title=" Strategies for Acquiring Your Own Laptop " alt=" Strategies for Acquiring Your Own Laptop " width="100px" src="image/demo/shop/product/E3.jpg"></td>
						  <td class="text-center"><img class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" width="100px" src="image/demo/shop/product/e3_3.jpg"></td>
						</tr>
						<tr>
						  <td>Price</td>
						  <td><div class="price"><span class="price-new">$1,142.00</span> <span class="price-old">$1,202.00</span> </div></td>
						  <td><div class="price"> <span class="price-new">$1,400.00</span> <span class="price-old">$1,900.00</span></div></td>
						  <td><div class="price"><span class="price-new">$230.00</span> <span class="price-old">$241.99</span> </div></td>
						</tr>
						<tr>
						  <td>Model</td>
						  <td>Product 17</td>
