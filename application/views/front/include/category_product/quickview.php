						 ...
						 <div class="row">
							 <div class="content-product-left  col-sm-6 col-xs-12 ">
								 <div class="large-image  ">
									 <img itemprop="image" class="product-image-zoom" src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/j9.jpg" data-zoom-image="image/demo/shop/product/j9.jpg" title="Bint Beef" alt="Bint Beef" />
								 </div>
								 ...
								 <div id="thumb-slider" class="owl-theme owl-loaded owl-drag full_slider">
									 ...
									 <a data-index="1" class="img thumbnail" data-image="image/demo/shop/product/j6.jpg" title="Bint Beef">
										 <img src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/j6.jpg" title="Bint Beef" alt="Bint Beef" />
									 </a>
									 <a data-index="2" class="img thumbnail" data-image="image/demo/shop/product/j5.jpg" title="Bint Beef">
										 <img src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/j5.jpg" title="Bint Beef" alt="Bint Beef" />
									 </a>
									 <a data-index="3" class="img thumbnail" data-image="image/demo/shop/product/j4.jpg" title="Bint Beef">
										 <img src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/j4.jpg" title="Bint Beef" alt="Bint Beef" />
									 </a>
								 </div>
										 ...
										 <ul class="product-options clearfix" id="input-option231">
											 <li class="radio">
												 <label>
													 ...
													 <img src="<?= base_url(); ?>assets/frontend/image/demo/colors/blue.jpg" data-original-title="blue +$12.00" class="img-thumbnail icon icon-color" />				 <i class="fa fa-check"></i>
													 <label>  </label>
												 </label>
											 </li>
											 <li class="radio">
												 <label>
													 ...
													 <img src="<?= base_url(); ?>assets/frontend/image/demo/colors/brown.jpg" data-original-title="brown -$12.00" class="img-thumbnail icon icon-color" />				 <i class="fa fa-check"></i>
													 <label>  </label>
												 </label>
											 </li>
											 <li class="radio">
				 ...
				 <script type="text/javascript">
					...
					var cart = {
						'add': function(product_id, quantity) {
							parent.addProductNotice('Product added to Cart', '<img src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/e11.jpg" alt="">', '<h3><a href="#">Apple Cinema 30"</a> added to <a href="#">shopping cart</a>!</h3>', 'success');
						}
					}

					var wishlist = {
						'add': function(product_id) {
							parent.addProductNotice('Product added to Wishlist', '<img src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/e11.jpg" alt="">', '<h3>You must <a href="#">login</a>  to save <a href="#">Apple Cinema 30"</a> to your <a href="#">wish list</a>!</h3>', 'success');
						}
					}
					var compare = {
						'add': function(product_id) {
							parent.addProductNotice('Product added to compare', '<img src="<?= base_url(); ?>assets/frontend/image/demo/shop/product/e11.jpg" alt="">', '<h3>Success: You have added <a href="#">Apple Cinema 30"</a> to your <a href="#">product comparison</a>!</h3>', 'success');
						}
					}
